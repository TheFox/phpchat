...
class Connection
{
    ...
    public function functionExec($name, $args = [])
    {
        ...
        if ($objc === null && $func === null) {
            ...
            return call_user_func_array([$objc, $func], $args);
    ...
    private function execAdd($name, $args = [], $retnFunc = null, $timeout = null, $type = null)
    {
        $this->execsId++;

        $this->execs[$this->execsId] = [
            'id' => $this->execsId,
            'name' => $name,
            'execRetn' => $retnFunc,
            'hasReturned' => false,
    ...
    public function exec($name, $args = [], $retnFunc = null)
    {
        $this->execAsync($name, $args, $retnFunc);
    }

    public function execAsync($name, $args = [], $retnFunc = null)
    {
    ...
    public function execSync($name, $args = [], $timeout = null)
    {
