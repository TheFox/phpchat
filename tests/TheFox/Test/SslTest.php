...
';
    ...
    public function providerFunctions()
    {
        ...
        $rv[] = ['openssl_pkey_new'];
        $rv[] = ['openssl_pkey_export'];
        $rv[] = ['openssl_pkey_export_to_file'];
        $rv[] = ['openssl_pkey_get_details'];
        $rv[] = ['openssl_public_encrypt'];
        $rv[] = ['openssl_private_decrypt'];
        $rv[] = ['openssl_error_string'];
        $rv[] = ['openssl_pkey_get_public'];
        $rv[] = ['openssl_pkey_get_private'];
        $rv[] = ['openssl_sign'];
        $rv[] = ['openssl_verify'];
        $rv[] = ['openssl_encrypt'];
        $rv[] = ['openssl_decrypt'];
