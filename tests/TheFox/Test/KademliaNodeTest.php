...
-----END PUBLIC KEY-----';
    ...
    {
        $node = new Node();
        $this->assertEquals([], $node->getBridgeDst());

        $node->addBridgeDst([]);
        $this->assertEquals([], $node->getBridgeDst());

        $node->addBridgeDst(['192.168.241.24:25000']);
        $this->assertEquals(['192.168.241.24:25000'], $node->getBridgeDst());

        $node->addBridgeDst(['192.168.241.25:25000']);
        $this->assertEquals(['192.168.241.24:25000', '192.168.241.25:25000'], $node->getBridgeDst());

        $node->addBridgeDst('192.168.241.26:25000');
        $this->assertEquals(['192.168.241.24:25000', '192.168.241.25:25000',
